...
def legacy_dashboard(timeframe: str = Query("30m")):
    """Backward-compatible dashboard endpoint for older cached clients."""
    try:
        price = get_price()
        ...
        return {
            ...
            "sell": price.get("sell", price.get("bid")),
            "buy": price.get("buy", price.get("ask")),
            ...
            "news": news_data,
            "call": signal.get("call", "WAIT"),
            "buy_probability": signal.get("buy_probability"),
            "sell_probability": signal.get("sell_probability"),
